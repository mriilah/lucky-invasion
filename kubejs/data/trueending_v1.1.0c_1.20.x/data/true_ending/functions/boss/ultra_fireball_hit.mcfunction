...
execute at @s align y run summon area_effect_cloud ~ ~.2 ~ {Tags:["trueEnding_dragonbreath","trueEnding_dragonbreath_temp"],Particle:"dragon_breath",Radius:4f,RadiusPerTick:0f,Duration:1200,ReapplicationDelay:20,Effects:[{Id:7,Amplifier:0b,Duration:1}]}
